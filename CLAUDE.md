...
- Rust (stable, 2024 edition) + `tiberius` 0.12 (TDS client), `tokio-util` 0.7 (compat layer), `futures-util` 0.3 (stream helpers); existing: `tokio` 1, `clap` 4.5, `serde`/`toml`, `secrecy` 0.10, `thiserror` 2, `anyhow` 1 (007-tiberius-mssql)
- N/A — no database changes, no local storage changes (007-tiberius-mssql)
...
## Recent Changes
- 007-tiberius-mssql: Added Rust (stable, 2024 edition) + `tiberius` 0.12 (TDS client), `tokio-util` 0.7 (compat layer), `futures-util` 0.3 (stream helpers); existing: `tokio` 1, `clap` 4.5, `serde`/`toml`, `secrecy` 0.10, `thiserror` 2, `anyhow` 1
